...
execute at @e[type=minecraft:marker,tag=EtiUhrzeitS.2Sensor,sort=nearest,limit=1] run data modify storage uhrzeit-sensor:v2daten "EigUhrzeitS.2Uhrzeit" set string block ~ ~ ~ LastOutput 10 18
