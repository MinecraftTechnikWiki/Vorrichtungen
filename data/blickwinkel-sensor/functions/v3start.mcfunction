...
summon minecraft:armor_stand ~-10 ~ ~ {Small:true,NoGravity:true,Invisible:true,CustomNameVisible:true,CustomName:'{"text":"Schau auf mich!","bold":true}',Tags:["EtiBlWS.3Alle","EtiBlWS.3Anschauen"],ArmorItems:[{},{},{},{id:"minecraft:observer",count:1}]}
...
give @a[distance=..15] minecraft:armor_stand[minecraft:entity_data={ArmorItems:[{},{},{},{count:1,id:"minecraft:observer"}],CustomName:'{"text":"Schau auf mich!","bold":true}',CustomNameVisible:true,Invisible:true,NoGravity:true,Small:true,Tags:["EtiBlWS.3Alle","EtiBlWS.3Anschauen"],id:"minecraft:armor_stand"},minecraft:custom_data={EigBlWS.3Alle:true}]
