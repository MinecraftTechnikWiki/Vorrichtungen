...
tellraw @s[scores={PZSprS.2Sprache=0..}] ["Sprachen-Sensor.2: "]
tellraw @s[scores={PZSprS.2Sprache=0}] ["",{text:"Die Sprache konnte leider nicht erkannt werden.",color:"red",bold:true} ]
tellraw @s[scores={PZSprS.2Sprache=1}] ["",{text:"Diese Welt wird in deutscher Sprache gespielt.",bold:true} ]
tellraw @s[scores={PZSprS.2Sprache=2}] ["",{text:"This world is played in English.",bold:true} ]
tellraw @s[scores={PZSprS.2Sprache=3}] ["",{text:"Ce monde se joue en français.",bold:true} ]
tellraw @s[scores={PZSprS.2Sprache=4}] ["",{text:"Este mundo se juega en español.",bold:true} ]
tellraw @s[scores={PZSprS.2Sprache=5}] ["",{text:"Questo mondo è suonato in italiano.",bold:true} ]
