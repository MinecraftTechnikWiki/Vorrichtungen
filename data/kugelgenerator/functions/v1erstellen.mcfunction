...
execute at @s positioned ~3 ~-3 ~ run fill ~ ~ ~3 ~ ~ ~-3 minecraft:command_block[facing=up]{auto:true,Command:'summon minecraft:armor_stand ~ ~ ~ {Small:true,NoGravity:true,Tags:["EtiKugelG.1Alle","EtiKugelG.1Kugel"]}'} replace
execute at @s positioned ~3 ~-2 ~ run fill ~ ~ ~3 ~ ~ ~-3 minecraft:chain_command_block[facing=up]{auto:true,Command:"fill ~ ~-1 ~ ~ ~ ~ minecraft:air"} replace
#execute positioned ~3 ~8 ~ run fill ~ ~ ~3 ~ ~ ~-3 minecraft:redstone_block replace
#execute positioned ~3 ~7 ~ run fill ~ ~ ~3 ~ ~1 ~-3 minecraft:air replace
#execute positioned ~3 ~7 ~ run fill ~ ~ ~3 ~ ~ ~-3 minecraft:air replace minecraft:command_block

#execute as @e[type=minecraft:armor_stand,tag=EtiKugelG.1Kugel] run say hi
