...
execute store result entity @n[type=minecraft:marker,tag=EtiChunkS.1Sensor] Pos[0] double 16 run scoreboard players operation VarChunkS.1X PZChunkS.1Wert /= KonstChunkS.1Chunk PZChunkS.1Wert
execute store result entity @n[type=minecraft:marker,tag=EtiChunkS.1Sensor] Pos[2] double 16 run scoreboard players operation VarChunkS.1Z PZChunkS.1Wert /= KonstChunkS.1Chunk PZChunkS.1Wert
...
execute at @n[type=minecraft:marker,tag=EtiChunkS.1Sensor] run summon minecraft:marker ~ ~ ~16 {Tags:["EtiChunkS.1Alle","EtiChunkS.1Sensor"]}
