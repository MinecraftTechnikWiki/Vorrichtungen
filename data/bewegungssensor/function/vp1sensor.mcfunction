...
execute at @n[type=minecraft:area_effect_cloud,tag=EtiBewS.p1Oben] run tag @s[distance=..0.5] add EtiBewS.p1Oben
...
execute at @n[type=minecraft:area_effect_cloud,tag=EtiBewS.p1Links] run title @s[distance=..0.1] actionbar ["",{text:"links",color:"red",bold:true}]
execute at @n[type=minecraft:area_effect_cloud,tag=EtiBewS.p1Rechts] run title @s[distance=..0.1] actionbar ["",{text:"rechts",color:"red",bold:true}]
