...
# Solange das Inventar nicht leer ist, wird die Suchen-Funktion erneut aufgerufen.
execute if data storage slot-sensor:v4daten {EigSlotS.4Inventar:[{}]} run function slot-sensor:v4suchen
