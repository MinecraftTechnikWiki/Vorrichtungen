...
execute at @e[type=minecraft:armor_stand,tag=EtiDropG.2Kupfer] run setblock ~ ~ ~ minecraft:waxed_copper_block keep
...
execute at @e[type=minecraft:armor_stand,tag=EtiDropG.2Kupfer,scores={PZDropG.2Tick=20}] run summon minecraft:item ~ ~1 ~ {Item:{id:"minecraft:copper_ingot",count:1,components:{"minecraft:custom_data":{EigDropG.2Alle:true} } },Motion:[0.0d,0.3d,0.0d],Tags:["EtiDropG.2Alle"] }
execute at @e[type=minecraft:armor_stand,tag=EtiDropG.2Eisen,scores={PZDropG.2Tick=20}] run summon minecraft:item ~ ~1 ~ {Item:{id:"minecraft:iron_ingot",count:1,components:{"minecraft:custom_data":{EigDropG.2Alle:true} } },Motion:[0.0d,0.3d,0.0d],Tags:["EtiDropG.2Alle"] }
execute at @e[type=minecraft:armor_stand,tag=EtiDropG.2Gold,scores={PZDropG.2Tick=20}] run summon minecraft:item ~ ~1 ~ {Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:custom_data":{EigDropG.2Alle:true} } },Motion:[0.0d,0.3d,0.0d],Tags:["EtiDropG.2Alle"] }
