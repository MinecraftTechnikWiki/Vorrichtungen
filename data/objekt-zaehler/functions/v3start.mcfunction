...
give @a[distance=..15] minecraft:piglin_spawn_egg[minecraft:entity_data={ArmorItems:[{},{},{},{components:{"minecraft:dyed_color":{rgb:16711680} },count:1,id:"minecraft:leather_helmet"}],DeathLootTable:"minecraft:empty",IsImmuneToZombification:true,Tags:["EtiObjZae.3Alle","EtiObjZae.3Objekt"],Team:"TMObjZae.3Team1",id:"minecraft:piglin"},minecraft:lore=['"Eine Kreatur zum"','"aufzählen"'],minecraft:custom_name='{"text":"Team1","color":"red","bold":true}',minecraft:custom_data={EigObjZae.3Alle:true}] 16

# Ein Piglin-Spawn-Ei das einen Piglin mit blauen Helm erzeugen kann.
give @a[distance=..15] minecraft:piglin_spawn_egg[minecraft:entity_data={ArmorItems:[{},{},{},{components:{"minecraft:dyed_color":{rgb:255} },count:1,id:"minecraft:leather_helmet"}],DeathLootTable:"minecraft:empty",IsImmuneToZombification:true,Tags:["EtiObjZae.3Alle","EtiObjZae.3Objekt"],Team:"TMObjZae.3Team2",id:"minecraft:piglin"},minecraft:lore=['"Eine Kreatur zum"','"aufzählen"'],minecraft:custom_name='{"text":"Team2","color":"blue","bold":true}',minecraft:custom_data={EigObjZae.3Alle:true}] 16
