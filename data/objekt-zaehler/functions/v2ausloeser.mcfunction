...
tellraw @s ["Objekt-Zähler.2: ",{"text":"\nmin = ","bold":true},{"text":"min + 1","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Minimum + 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZObjZae.2Ausl set 1"} },{"text":"\nmin = ","bold":true},{"text":"min - 1","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Minimum - 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZObjZae.2Ausl set -1"} },{"text":"\nmin == ","bold":true},{"score":{"name":"VarObjZae.2Min","objective":"PZObjZae.2Ausl"},"color":"gold","bold":true},{"text":"\nmax = ","bold":true},{"text":"max + 1","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Maximum + 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZObjZae.2Ausl set 2"} },{"text":"\nmax = ","bold":true},{"text":"max - 1","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Maximum - 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZObjZae.2Ausl set -2"} },{"text":"\nmax == ","bold":true},{"score":{"name":"VarObjZae.2Max","objective":"PZObjZae.2Ausl"},"color":"dark_red","bold":true}]
