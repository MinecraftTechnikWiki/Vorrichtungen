...
execute unless score VarObjZae.2Max PZObjZae.2Ausl matches 0 if score VarObjZae.2Anzahl PZObjZae.2Ausl > VarObjZae.2Max PZObjZae.2Ausl at @p[tag=EtiObjZae.2Ausgewaehlt] run kill @n[type=minecraft:piglin,tag=EtiObjZae.2Objekt]
...
execute if score VarObjZae.2Anzahl PZObjZae.2Ausl < VarObjZae.2Min PZObjZae.2Ausl at @r[tag=EtiObjZae.2Ausgewaehlt] run summon minecraft:piglin ~ ~ ~ {IsImmuneToZombification:true,Tags:["EtiObjZae.2Alle","EtiObjZae.2Objekt"],equipment:{head:{id:"minecraft:leather_helmet",count:1} } }
