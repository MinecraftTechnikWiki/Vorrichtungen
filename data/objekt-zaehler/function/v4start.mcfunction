...
give @a[distance=..25] minecraft:strider_spawn_egg[minecraft:entity_data={DeathLootTable:"minecraft:empty",Tags:["EtiObjZae.4Alle"],id:"minecraft:strider"},minecraft:lore=["Eine Kreatur zum","aufzählen"],minecraft:custom_data={EigObjZae.4Alle:true}]
