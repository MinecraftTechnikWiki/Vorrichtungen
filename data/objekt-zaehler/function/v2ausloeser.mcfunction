...
tellraw @s ["Objekt-Zähler.2:\n",{text:"min = ",bold:true},{text:"min + 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Minimum + 1"} },click_event:{action:"run_command",command:"/trigger PZObjZae.2Ausl set 1"} },"\n",{text:"min = ",bold:true},{text:"min - 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Minimum - 1"} },click_event:{action:"run_command",command:"/trigger PZObjZae.2Ausl set -1"} },"\n",{text:"min == ",bold:true},{score:{name:"VarObjZae.2Min",objective:"PZObjZae.2Ausl"},color:"gold",bold:true},"\n",{text:"max = ",bold:true},{text:"max + 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Maximum + 1"} },click_event:{action:"run_command",command:"/trigger PZObjZae.2Ausl set 2"} },"\n",{text:"max = ",bold:true},{text:"max - 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Maximum - 1"} },click_event:{action:"run_command",command:"/trigger PZObjZae.2Ausl set -2"} },"\n",{text:"max == ",bold:true},{score:{name:"VarObjZae.2Max",objective:"PZObjZae.2Ausl"},color:"dark_red",bold:true}]
